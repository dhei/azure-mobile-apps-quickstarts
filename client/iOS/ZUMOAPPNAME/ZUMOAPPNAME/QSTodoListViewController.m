...
- (void)loginAndGetData
{
    ...
    [self.todoService.client loginWithProvider:@"google" urlScheme:@"ZumoE2ETestApp" controller:self animated:YES completion:^(MSUser * _Nullable user, NSError * _Nullable error) {
        if (error) {
